...
import {ConductorTabsNavigator} from '../../../src/Presentation/navigator/ConductorTabsNavigator'
...
export type RootStackParamList = {
    ...
    ConductorTabsNavigator: undefined
  }
...
export const MainStackNavigator = () => {
  return (
    <UserState>
        ...
        <Stack.Screen
              name="ConductorTabsNavigator"
              component={ConductorTabsNavigator}
          />
