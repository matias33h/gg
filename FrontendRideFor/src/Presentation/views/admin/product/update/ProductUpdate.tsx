...
export const AdminProductUpdateScreen = ({navigation, route}: Props) => {
  ...
  const { name, description, responseMessage, loading, image1, image2, image3, price, patente, onChange, takePhoto, pickImage, updateProduct } = useViewModel(product, category);
...
<CustomTextInput 
            ...
            <View style={styles.buttonContainer}>
                 <RoundedButton 
                text='ACTUALIZAR PERFIL DEL CONDUCTOR'
