...
export const AdminProductCreateScreen = ({navigation, route}: Props) => {
  ...
  const { name, description, responseMessage, loading, image1, image2, image3, price, patente, onChange, takePhoto, pickImage, createProduct } = useViewModel(category);
    ...
    <View style={styles.container}>
        ...
        <View style={ styles.form }>
            ...
            <View style={styles.categoryInfo}>
                ...
                />
                <Text style={styles.textCategory}>Empresa Seleccionada:</Text>
...
<CustomTextInput 
            ...
            <View style={styles.buttonContainer}>
                 <RoundedButton 
                text='CREAR PERFIL DEL CONDUCTOR'
