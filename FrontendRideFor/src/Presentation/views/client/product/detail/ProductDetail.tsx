        ...
        <View style={styles.container}>
            ...
            <View style={styles.productDetail}>
                <View style={styles.productInfo}>
                    ...
                    {/* PRECIO */}
                    <Text style={ styles.descriptionTitle}>Patente</Text>
                    <Text style={ styles.descriptionContent }>{ product.patente }</Text>
                    <View style={styles.divider}></View>
                    ...
                    <Text style={ styles.descriptionContent }>Viajes: {quantity}</Text>
                ...
                <View style={styles.productActions}>
                    ...
                    <View style={styles.buttonAdd}>
                        <RoundedButton text='Seleccionar conductor' onPress={() => addToBag()} />
                    </View>
