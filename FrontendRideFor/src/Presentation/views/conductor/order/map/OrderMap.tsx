...
interface Props extends StackScreenProps<ConductorOrderStackParamList,'ConductorOrderMapScreen'>{}

export const ConductorOrderMapScreen = ({navigation,route}:Props) => {

  const {order} = route.params;
  const {messagePermissions,socket, position,mapRef,name,origin, destination, responseMessage, stopForegroundUpdate, updateToEntregadoOrder}=useViewModel(order)
...

{
    ...
    <View style={styles.infoClient}>
      ...
      <View style={styles.buttonRefPoint}>
        <RoundedButton
        text='TERMINAR VIAJE'
        onPress={()=> updateToEntregadoOrder()}
        />
      </View>
